...
namespace ae
{
    ...
    * <a href="http://stackoverflow.com/questions/26982371/find-multiple-adjacent-values-in-container">StackOverflow question</a> 
    *
    ...
    */
    ...
    Iter consecutive_find(Iter begin, Iter end, std::size_t n)
    {
        ...
        {
            for (lead = std::next(marker); (lead != end) && (*marker == *lead); ++count, ++lead);
