...
TEST(UT005EraseItem,
     RemoveRootItemWithOneChildRight_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(5);
    tree.insert(6);
...
TEST(UT005EraseItem,
     RemoveRootItemWithOneChildLeft_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(6);
    tree.insert(5);
...
TEST(UT005EraseItem,
     RemoveItemWithOneChildRight_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(10);
    tree.insert(9);
    tree.insert(11);
...
TEST(UT005EraseItem,
     RemoveItemWithOneChildLeft_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(10);
    tree.insert(9);
    tree.insert(11);
...
TEST(UT005EraseItem,
     RemoveRootItemWithTwoChildrenCloseZ_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(5);
    tree.insert(6);
    tree.insert(4);
...
TEST(UT005EraseItem,
     RemoveRootItemWithTwoChildrenFarZ_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(6);
    tree.insert(8);
    tree.insert(4);
...
TEST(UT005EraseItem,
     RemoveItemWithTwoChildrenCloseZ_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(100);
    tree.insert(50);
    tree.insert(150);
...
TEST(UT005EraseItem,
     RemoveItemWithTwoChildrenFarZ_NoThrowSizeCorrectAndCannotFind) {
    ae::Tree<int> tree;
    tree.insert(100);
    tree.insert(50);
    tree.insert(150);
