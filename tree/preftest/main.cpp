...
int main(int argc, char** argv) {
	...
	//Fill vector with NUM_OF_NODES million integers between - 1 million and + 1 million
	...
	std::cout << "STL Multiset Time : " << std::chrono::duration_cast<std::chrono::milliseconds>(stlEnd - stlStart).count() << " ms" << std::endl;
	std::cout << "AE Tree Time      : " << std::chrono::duration_cast<std::chrono::milliseconds>(myEnd - myStart).count() << " ms" << std::endl;
